...
export const workflows: Workflow[] = [
  // ───────────────────────────────────────────────────────────────────────── UI
  {
    ...
    steps: [
      ...
      },
      {
        ...
        chips: [core("requirement"), gst("office-hours")],
      },
      { num: "2", action: "畫螢幕轉換 + 分支", chips: [core("user-flow")] },
      { num: "3", action: "Design system / brand direction", chips: [gst("design-consultation")] },
      { num: "4", action: "產生 design variants，挑一個", chips: [gst("design-shotgun")] },
      { num: "5", action: "Mockup → 定靜態 HTML", chips: [core("mockup"), gst("design-html")] },
      {
        num: "6",
        ...
        optionals: [
          {
            ...
            chips: [
              gst("plan-eng-review"),
              gst("plan-design-review"),
              gst("plan-ceo-review"),
              gst("autoplan"),
            ],
            inlineNote: "大功能用 /autoplan 一鍵跑全部",
          },
        ],
      },
      {
        ...
        optionals: [
          {
            label: "遇到 bug:",
            chips: [gst("investigate")],
            secondLabel: "重構時 lock 穩定區:",
            secondChips: [gst("freeze"), gst("unfreeze")],
          },
          {
            label: "破壞性命令前:",
            chips: [crit("careful")],
            secondLabel: "獨立第二意見:",
            secondChips: [gst("codex")],
          },
        ],
      },
      { num: "8", action: "Pre-commit diff review", chips: [gst("review")] },
      {
        num: "9",
      ...
      },
      {
        num: "10",
        action: "部署",
        chips: [gst("land-and-deploy"), gst("ship")],
        inlineNote: "land-and-deploy = CI/CD 環境，ship = 非 CI 環境",
        optionals: [
          {
            label: "部署後:",
            chips: [gst("canary"), gst("document-release")],
          },
        ],
      },
    ],
  ...
  // ───────────────────────────────────────────────────────────────────── BACKEND
  {
    ...
    steps: [
      ...
      { num: "1", action: "Root cause first（bugs）", chips: [gst("investigate")] },
      { num: "2", action: "實作" },
      { num: "3", action: "Diff review", chips: [gst("review")] },
      {
        num: "4",
        action: "破壞性命令前確認",
        chips: [crit("careful")],
        ...
        steps: [
            ...
            optionals: [
              {
                ...
                secondLabel: "從零開始:",
                secondChips: [core("ui-ux-pro-max"), gst("design-consultation")],
              },
            ],
          },
          { num: "5", action: "大綱 → 內容（7 階段）", chips: [core("slide-workflow")] },
          {
            ...
            optionals: [
              ...
              { label: "HTML deck:", chips: [gst("design-html")] },
            ],
          },
          {
            num: "7",
          ...
          { num: "8", action: "審查視覺一致性", chips: [gst("design-review")] },
        ],
      },
    ],
  },
  ...
  // ─────────────────────────────────────────────────────────────── MAINTENANCE
  {
    ...
    maintenance: [
      { when: "遇到不明 bug", chips: [gst("investigate")] },
      {
        when: "每次 ship 前",
        chips: [crit("careful")],
        sequence: [
          { connector: "arrow", chips: [gst("review")] },
          { connector: "arrow", chips: [gst("qa")] },
        ],
      },
      {
        when: "每次 ship 後",
        chips: [gst("canary")],
        sequence: [{ connector: "arrow", chips: [gst("document-release")] }],
      },
      { when: "定期 UI 健檢（不修）", chips: [gst("qa-only")] },
      {
        when: "重構時保護穩定區域",
        chips: [gst("freeze")],
        sequence: [{ connector: "then", chips: [gst("unfreeze")] }],
      },
      { when: "需要獨立第二意見", chips: [gst("codex")] },
      { when: "每週 retro", chips: [gst("retro")] },
      { when: "安全審計（上線前）", chips: [gst("cso")] },
      { when: "gstack 有 UPGRADE_AVAILABLE", chips: [gst("gstack-upgrade")] },
      { when: "學到新東西 / 踩坑", chips: [gst("learn")] },
    ],
  },
];
