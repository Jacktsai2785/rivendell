...
**meta/**
- self-improving-agent — 2 次修訂, 4天前

**workflow/**
- headless-agent — 6 次修訂, 10天前
- launchd-agent — 3 次修訂, 10天前
- tender-scraper — 3 次修訂, 10天前

<details><summary>✅ 穩定 (61)</summary>

**backend/**
- db-migration — 1 次, 22天前
- doc-to-structured-data — 1 次, 8天前
- firebase-backend — 1 次, 26天前
- imap-smtp-integration — 1 次, 10天前
- markdown-file-ssot — 1 次, 10天前
- oauth-token-vault — 1 次, 10天前
- sqlite-to-postgres — 1 次, 19天前
- tunnel-proxy-deploy — 1 次, 19天前
- tw-company-lookup — 2 次, 18天前
- vector-search-setup — 1 次, 4天前

**docs/**
- mcp-builder — 3 次, 24天前
- office-docx — 3 次, 24天前
- office-pdf — 3 次, 24天前
- office-pptx — 3 次, 24天前
- office-xlsx — 3 次, 24天前
- telegram-bot — 1 次, 19天前

**frontend/**
- frontend-design — 2 次, 25天前
- ios-integration — 1 次, 26天前
- swiftui-patterns — 1 次, 26天前
- ui-ux-pro-max — 3 次, 24天前
...
**meta/**
- audit-fix — 1 次, 22天前
- ci-pipeline — 1 次, 22天前
- deploy — 1 次, 22天前
- dev-process-gate — 3 次, 22天前
- init-project — 2 次, 25天前
- knowledge-graph — 1 次, 19天前
- plan-check-style — 3 次, 22天前
- session-harvest — 1 次, 19天前
- setup-permissions — 3 次, 22天前
- skill-creator — 2 次, 25天前
- skill-scout — 1 次, 19天前
- sync-readme — 1 次, 3天前

**quality/**
- de-slopify — 1 次, 19天前
- large-file-refactor — 1 次, 4天前
- protect-secrets — 1 次, 8天前
- qa-auto — 1 次, 19天前
- qa-planner — 1 次, 19天前
- qa-testing — 1 次, 24天前

**workflow/**
- agent-observability — 1 次, 9天前
- autoresearch — 1 次, 10天前
- candidate-analysis — 1 次, 8天前
- claude-to-telegram — 1 次, 19天前
- context-recovery — 1 次, 19天前
- crm-projection — 1 次, 18天前
- customer-intel — 4 次, 18天前
- dispatching-parallel-agents — 3 次, 24天前
- executing-plans — 3 次, 24天前
- gdrive-to-skills — 2 次, 25天前
- investment-research — 3 次, 19天前
- keyword-discovery — 1 次, 10天前
- material-health — 1 次, 18天前
- mockup — 1 次, 26天前
- planning-with-files — 4 次, 20天前
- requirement — 1 次, 26天前
- sales-material — 1 次, 18天前
- settings-audit — 1 次, 9天前
- subsidy-scraper — 1 次, 18天前
- user-flow — 1 次, 26天前
- writing-plans — 3 次, 24天前
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["03-28", "03-29", "03-30", "03-31", "04-01", "04-02", "04-03"]
    y-axis "USD" 0 --> 650
    bar [31, 12, 567, 326, 116, 151, 0]
~~~
...
| 2026-04-03 (Fri) | 3 | 3 | 0 | $0.00 |
| **Total** | | | **480.9M** | **$1201.89** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| Family-Fiscal | 2,172 | 203.3M | $459.96 |
| -Users-manibari-Documents-Projects | 1,401 | 127.3M | $313.60 |
| rivendell | 761 | 60.4M | $148.44 |
| sales-assistant | 509 | 36.3M | $103.05 |
| news-stock | 260 | 22.5M | $73.75 |
| curia | 249 | 20.5M | $67.13 |
...
*由以下工具產生 `./bin/sk audit` — 2026-04-03 — 65 skills, 19 issue(s)*
