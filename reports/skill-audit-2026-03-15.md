...
**workflow/**
- customer-intel — 尚未 commit

### 🔧 開發中

**docs/**
- mcp-builder — 3 次修訂, 5天前
- office-docx — 3 次修訂, 5天前
- office-pdf — 3 次修訂, 5天前
- office-pptx — 3 次修訂, 5天前
- office-xlsx — 3 次修訂, 5天前

**frontend/**
- frontend-design — 2 次修訂, 6天前
- ui-ux-pro-max — 3 次修訂, 5天前
- webapp-testing — 3 次修訂, 5天前

**git/**
- review-pr — 3 次修訂, 5天前

**meta/**
- dev-process-gate — 3 次修訂, 3天前
- init-project — 2 次修訂, 6天前
- plan-check-style — 3 次修訂, 3天前
- setup-permissions — 3 次修訂, 3天前
- skill-creator — 2 次修訂, 6天前

**quality/**
- code-reviewer — 3 次修訂, 5天前
- security-review — 3 次修訂, 5天前
- systematic-debugging — 2 次修訂, 6天前

**workflow/**
- dispatching-parallel-agents — 3 次修訂, 5天前
- executing-plans — 3 次修訂, 5天前
- gdrive-to-skills — 2 次修訂, 6天前
- headless-agent — 2 次修訂, 0天前
- investment-research — 3 次修訂, 0天前
- planning-with-files — 4 次修訂, 1天前
- writing-plans — 3 次修訂, 5天前

<details><summary>✅ 穩定 (26)</summary>

**backend/**
- db-migration — 1 次, 3天前
- firebase-backend — 1 次, 7天前
- sqlite-to-postgres — 1 次, 0天前
- tunnel-proxy-deploy — 1 次, 0天前

**docs/**
- telegram-bot — 1 次, 0天前

**frontend/**
- ios-integration — 1 次, 7天前
- swiftui-patterns — 1 次, 7天前

**meta/**
- audit-fix — 1 次, 3天前
- ci-pipeline — 1 次, 3天前
- deploy — 1 次, 3天前
- knowledge-graph — 1 次, 0天前
- self-improving-agent — 1 次, 0天前
- session-harvest — 1 次, 0天前
- skill-scout — 1 次, 0天前

**quality/**
- de-slopify — 1 次, 0天前
- destructive-command-guard — 1 次, 0天前
- post-change-qa — 1 次, 3天前
- qa-auto — 1 次, 0天前
- qa-planner — 1 次, 0天前
- qa-testing — 1 次, 5天前

**workflow/**
- claude-to-telegram — 1 次, 0天前
- context-recovery — 1 次, 0天前
- launchd-agent — 1 次, 0天前
- mockup — 1 次, 7天前
- requirement — 1 次, 7天前
- user-flow — 1 次, 7天前
...
| | |
|---|---|
| **狀態** | 🔥 活躍 — 7 個 commit（本週）, 29 個（本月） |
| **技術棧** |  Node.js Xcode |
| **分支** | `main` (1 total) |
| **Git** | 23 dirty, 6 unpushed |
| **CI/CD** | CI ❌ · 部署 ❌ · Hooks ❌ |
...
19288f5 chore(agent): research-agent run 2026-03-15
c1a9f79 chore(agent): research-agent run 2026-03-15
```
</details>
...
```
aa0a284 chore: add root package.json (playwright) and gitignore tsbuildinfo
11b77c7 fix: resolve TypeScript build errors for M1 deployment
24f8276 feat: add one-command deploy script for M1 deployment
85efc6b chore: gitignore root node_modules and telegram session data
d12c331 feat: intel-meeting linking, deal delete, and idempotent deal-intel link
```
</details>
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["03-09", "03-10", "03-11", "03-12", "03-13", "03-14", "03-15"]
    y-axis "USD" 0 --> 800
    bar [362, 195, 707, 125, 92, 471, 325]
~~~
...
| 2026-03-15 (Sun) | 17 | 1,823 | 151.7M | $325.47 |
| **Total** | | | **934.3M** | **$2276.64** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| sales-assistant | 4,437 | 408.0M | $885.48 |
| skills-test | 2,903 | 214.2M | $512.06 |
| -Users-manibari-Documents-Projects | 1,405 | 129.4M | $324.87 |
| TailTrack | 740 | 73.2M | $197.98 |
| -Users-manibari-Documents-Chimes-AI-richwave | 552 | 45.9M | $148.75 |
| news-stock | 612 | 31.8M | $126.20 |
| scraper | 386 | 31.5M | $79.50 |
| news_stock | 6 | 162K | $11.02 |
...
*由以下工具產生 `./bin/sk audit` — 2026-03-15 — 51 skills, 7 issue(s)*
