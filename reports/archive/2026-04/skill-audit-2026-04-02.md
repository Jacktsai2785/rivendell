...
**meta/**
- self-improving-agent — 2 次修訂, 3天前

**workflow/**
- headless-agent — 6 次修訂, 9天前
- launchd-agent — 3 次修訂, 9天前
- tender-scraper — 3 次修訂, 9天前

<details><summary>✅ 穩定 (61)</summary>

**backend/**
- db-migration — 1 次, 21天前
- doc-to-structured-data — 1 次, 7天前
- firebase-backend — 1 次, 25天前
- imap-smtp-integration — 1 次, 9天前
- markdown-file-ssot — 1 次, 9天前
- oauth-token-vault — 1 次, 9天前
- sqlite-to-postgres — 1 次, 18天前
- tunnel-proxy-deploy — 1 次, 18天前
- tw-company-lookup — 2 次, 17天前
- vector-search-setup — 1 次, 3天前

**docs/**
- mcp-builder — 3 次, 23天前
- office-docx — 3 次, 23天前
- office-pdf — 3 次, 23天前
- office-pptx — 3 次, 23天前
- office-xlsx — 3 次, 23天前
- telegram-bot — 1 次, 18天前

**frontend/**
- frontend-design — 2 次, 24天前
- ios-integration — 1 次, 25天前
- swiftui-patterns — 1 次, 25天前
- ui-ux-pro-max — 3 次, 23天前
...
**meta/**
- audit-fix — 1 次, 21天前
- ci-pipeline — 1 次, 21天前
- deploy — 1 次, 21天前
- dev-process-gate — 3 次, 21天前
- init-project — 2 次, 24天前
- knowledge-graph — 1 次, 18天前
- plan-check-style — 3 次, 21天前
- session-harvest — 1 次, 18天前
- setup-permissions — 3 次, 21天前
- skill-creator — 2 次, 24天前
- skill-scout — 1 次, 18天前
- sync-readme — 1 次, 2天前

**quality/**
- de-slopify — 1 次, 18天前
- large-file-refactor — 1 次, 3天前
- protect-secrets — 1 次, 7天前
- qa-auto — 1 次, 18天前
- qa-planner — 1 次, 18天前
- qa-testing — 1 次, 23天前

**workflow/**
- agent-observability — 1 次, 8天前
- autoresearch — 1 次, 9天前
- candidate-analysis — 1 次, 7天前
- claude-to-telegram — 1 次, 18天前
- context-recovery — 1 次, 18天前
- crm-projection — 1 次, 17天前
- customer-intel — 4 次, 17天前
- dispatching-parallel-agents — 3 次, 23天前
- executing-plans — 3 次, 23天前
- gdrive-to-skills — 2 次, 24天前
- investment-research — 3 次, 18天前
- keyword-discovery — 1 次, 9天前
- material-health — 1 次, 17天前
- mockup — 1 次, 25天前
- planning-with-files — 4 次, 19天前
- requirement — 1 次, 25天前
- sales-material — 1 次, 17天前
- settings-audit — 1 次, 8天前
- subsidy-scraper — 1 次, 17天前
- user-flow — 1 次, 25天前
- writing-plans — 3 次, 23天前
...
|---------|-------|----------|--------|-----------|
| news_stock | research-agent | daily 7:30 | ● loaded | 126 |
...
| rivendell | maintain | daily 22:00 | ● loaded | 126 |
| rivendell | harvest | interval :00 | ● loaded | 0 |
| rivendell | tester | daily 6:00 | ● loaded | 126 |
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["03-27", "03-28", "03-29", "03-30", "03-31", "04-01", "04-02"]
    y-axis "USD" 0 --> 650
    bar [228, 31, 12, 567, 326, 116, 131]
~~~
...
| 2026-04-02 (Thu) | 12 | 681 | 56.0M | $130.60 |
| **Total** | | | **552.7M** | **$1410.40** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| Family-Fiscal | 2,292 | 213.0M | $488.07 |
| -Users-manibari-Documents-Projects | 1,574 | 144.3M | $358.71 |
| sales-assistant | 659 | 57.6M | $164.06 |
| rivendell | 803 | 62.5M | $155.38 |
| news-stock | 440 | 39.9M | $123.74 |
| curia | 282 | 24.8M | $84.49 |
...
*由以下工具產生 `./bin/sk audit` — 2026-04-02 — 65 skills, 20 issue(s)*
