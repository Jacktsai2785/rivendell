...
**backend/**
- tw-company-lookup — 2 次修訂, 0天前

**docs/**
- mcp-builder — 3 次修訂, 6天前
- office-docx — 3 次修訂, 6天前
- office-pdf — 3 次修訂, 6天前
- office-pptx — 3 次修訂, 6天前
- office-xlsx — 3 次修訂, 6天前

**frontend/**
- frontend-design — 2 次修訂, 7天前
- ui-ux-pro-max — 3 次修訂, 6天前
- webapp-testing — 3 次修訂, 6天前

**git/**
- review-pr — 3 次修訂, 6天前

**meta/**
- dev-process-gate — 3 次修訂, 4天前
- init-project — 2 次修訂, 7天前
- plan-check-style — 3 次修訂, 4天前
- setup-permissions — 3 次修訂, 4天前
- skill-creator — 2 次修訂, 7天前

**quality/**
- code-reviewer — 3 次修訂, 6天前
- security-review — 3 次修訂, 6天前
- systematic-debugging — 2 次修訂, 7天前

**workflow/**
- customer-intel — 4 次修訂, 0天前
- dispatching-parallel-agents — 3 次修訂, 6天前
- executing-plans — 3 次修訂, 6天前
- gdrive-to-skills — 2 次修訂, 7天前
- headless-agent — 2 次修訂, 1天前
- investment-research — 3 次修訂, 1天前
- planning-with-files — 4 次修訂, 2天前
- writing-plans — 3 次修訂, 6天前

<details><summary>✅ 穩定 (31)</summary>

**backend/**
- db-migration — 1 次, 4天前
- firebase-backend — 1 次, 8天前
- sqlite-to-postgres — 1 次, 1天前
- tunnel-proxy-deploy — 1 次, 1天前
- web-scraper — 1 次, 0天前

**docs/**
- telegram-bot — 1 次, 1天前

**frontend/**
- ios-integration — 1 次, 8天前
- swiftui-patterns — 1 次, 8天前

**meta/**
- audit-fix — 1 次, 4天前
- ci-pipeline — 1 次, 4天前
- deploy — 1 次, 4天前
- knowledge-graph — 1 次, 1天前
- self-improving-agent — 1 次, 1天前
- session-harvest — 1 次, 1天前
- skill-scout — 1 次, 1天前

**quality/**
- de-slopify — 1 次, 1天前
- destructive-command-guard — 1 次, 1天前
- post-change-qa — 1 次, 4天前
- qa-auto — 1 次, 1天前
- qa-planner — 1 次, 1天前
- qa-testing — 1 次, 6天前

**workflow/**
- claude-to-telegram — 1 次, 1天前
- context-recovery — 1 次, 1天前
- crm-projection — 1 次, 0天前
- launchd-agent — 1 次, 1天前
- material-health — 1 次, 0天前
- mockup — 1 次, 8天前
- requirement — 1 次, 8天前
- sales-material — 1 次, 0天前
- subsidy-scraper — 1 次, 0天前
- user-flow — 1 次, 8天前
...
```
851324e chore(agent): research-agent-daily run 2026-03-16
35897b1 feat: add calendar collector, adjust ports to avoid conflicts
3da3500 chore(agent): research-agent-daily run 2026-03-15
9389392 chore(agent): research-agent-weekly run 2026-03-15
9de4c2d chore(agent): research-agent-daily run 2026-03-15
```
</details>
...
| | |
|---|---|
| **狀態** | 🔥 活躍 — 51 個 commit（本週）, 69 個（本月） |
| **技術棧** |  Docker Node.js Python |
| **分支** | `main` (1 total) |
| **Git** | 3 dirty |
| **CI/CD** | CI ❌ · 部署 ❌ · Hooks ✅ |
| **Config** | OK | **權限** | OK (28 rules) |

<details><summary>近期 commits</summary>

```
8af4477 fix(calendar): extend time grid to 07:00-22:00 and auto-scroll to now
2c42884 feat: move customer-intel reports into sales-assistant + add 穩德文具印刷
60c9abc feat(knowledge): add global knowledge base page with cross-client search
996adb3 feat: populate 52 subsidy programs with scraped deadlines + client matching
0904c4b fix: align UPLOADS_DIR path and bypass proxy for file uploads
```
</details>
...
```
bd13ccc Add multi-tenant middleware, Docker setup, and deployment config (Phase 8)
c90834a Add Telegram and Email notification service (Phase 7)
8acf66e Add Next.js frontend with all core pages (Phase 6)
4d7e877 Add competitor tracking and analysis API (Phase 5)
c8748ee Add recommendation engine with preference learning (Phase 4)
```
</details>
...
| skills-test | maintain | daily 22:00 | ● loaded | 0 |
| skills-test | harvest | interval :00 | ● loaded | 0 |
| skills-test | tester | daily 6:00 | ● loaded | 0 |
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["03-10", "03-11", "03-12", "03-13", "03-14", "03-15", "03-16"]
    y-axis "USD" 0 --> 800
    bar [195, 707, 125, 92, 471, 688, 3]
~~~
...
| 2026-03-16 (Mon) | 1 | 15 | 491K | $2.70 |
| **Total** | | | **961.7M** | **$2279.32** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| sales-assistant | 4,269 | 403.7M | $835.88 |
| -Users-manibari-Documents-Projects | 1,907 | 194.1M | $462.19 |
| skills-test | 2,624 | 185.6M | $448.21 |
| TailTrack | 678 | 67.2M | $174.17 |
| -Users-manibari-Documents-Chimes-AI-richwave | 552 | 45.9M | $148.75 |
| news-stock | 652 | 33.4M | $128.82 |
| scraper | 386 | 31.5M | $79.50 |
| news_stock | 7 | 183K | $12.39 |
...
*由以下工具產生 `./bin/sk audit` — 2026-03-16 — 57 skills, 10 issue(s)*
