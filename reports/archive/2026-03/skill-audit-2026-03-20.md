...
**backend/**
- tw-company-lookup — 2 次修訂, 4天前

**docs/**
- mcp-builder — 3 次修訂, 10天前
- office-docx — 3 次修訂, 10天前
- office-pdf — 3 次修訂, 10天前
- office-pptx — 3 次修訂, 10天前
- office-xlsx — 3 次修訂, 10天前

**frontend/**
- frontend-design — 2 次修訂, 11天前
- ui-ux-pro-max — 3 次修訂, 10天前
- webapp-testing — 3 次修訂, 10天前

**git/**
- review-pr — 3 次修訂, 10天前

**meta/**
- dev-process-gate — 3 次修訂, 8天前
- init-project — 2 次修訂, 11天前
- plan-check-style — 3 次修訂, 8天前
- setup-permissions — 3 次修訂, 8天前
- skill-creator — 2 次修訂, 11天前

**quality/**
- code-reviewer — 3 次修訂, 10天前
- security-review — 3 次修訂, 10天前
- systematic-debugging — 2 次修訂, 11天前

**workflow/**
- customer-intel — 4 次修訂, 4天前
- dispatching-parallel-agents — 3 次修訂, 10天前
- executing-plans — 3 次修訂, 10天前
- gdrive-to-skills — 2 次修訂, 11天前
- headless-agent — 3 次修訂, 2天前
- investment-research — 3 次修訂, 5天前
- planning-with-files — 4 次修訂, 6天前
- tender-scraper — 2 次修訂, 2天前
- writing-plans — 3 次修訂, 10天前

<details><summary>✅ 穩定 (31)</summary>

**backend/**
- db-migration — 1 次, 8天前
- firebase-backend — 1 次, 12天前
- sqlite-to-postgres — 1 次, 5天前
- tunnel-proxy-deploy — 1 次, 5天前
- web-scraper — 1 次, 4天前

**docs/**
- telegram-bot — 1 次, 5天前

**frontend/**
- ios-integration — 1 次, 12天前
- swiftui-patterns — 1 次, 12天前

**meta/**
- audit-fix — 1 次, 8天前
- ci-pipeline — 1 次, 8天前
- deploy — 1 次, 8天前
- knowledge-graph — 1 次, 5天前
- self-improving-agent — 1 次, 5天前
- session-harvest — 1 次, 5天前
- skill-scout — 1 次, 5天前

**quality/**
- de-slopify — 1 次, 5天前
- destructive-command-guard — 1 次, 5天前
- post-change-qa — 1 次, 8天前
- qa-auto — 1 次, 5天前
- qa-planner — 1 次, 5天前
- qa-testing — 1 次, 10天前

**workflow/**
- claude-to-telegram — 1 次, 5天前
- context-recovery — 1 次, 5天前
- crm-projection — 1 次, 4天前
- launchd-agent — 1 次, 5天前
- material-health — 1 次, 4天前
- mockup — 1 次, 12天前
- requirement — 1 次, 12天前
- sales-material — 1 次, 4天前
- subsidy-scraper — 1 次, 4天前
- user-flow — 1 次, 12天前
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["03-14", "03-15", "03-16", "03-17", "03-18", "03-19", "03-20"]
    y-axis "USD" 0 --> 750
    bar [471, 688, 5, 554, 321, 49, 0]
~~~
...
| 2026-03-20 (Fri) | 2 | 2 | 0 | $0.00 |
| **Total** | | | **853.0M** | **$2088.00** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| sales-assistant | 3,001 | 290.0M | $656.41 |
| -Users-manibari-Documents-Projects | 1,838 | 232.3M | $529.36 |
| skills-test | 2,738 | 188.8M | $469.55 |
| news-stock | 1,097 | 70.9M | $239.81 |
| scraper | 285 | 27.7M | $68.01 |
| -Users-manibari-Documents-Chimes-AI-josun | 264 | 23.9M | $58.87 |
| rivendell | 256 | 13.9M | $31.56 |
| TailTrack | 16 | 2.5M | $21.53 |
| news_stock | 13 | 313K | $21.10 |
| -Users-manibari-Documents-Chimes-AI-richwave | 64 | 2.6M | $11.09 |
...
*由以下工具產生 `./bin/sk audit` — 2026-03-20 — 61 skills, 17 issue(s)*
