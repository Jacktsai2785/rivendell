...
**backend/**
- tw-company-lookup — 2 次修訂, 8天前
- web-scraper — 2 次修訂, 0天前

**docs/**
- mcp-builder — 3 次修訂, 14天前
- office-docx — 3 次修訂, 14天前
- office-pdf — 3 次修訂, 14天前
- office-pptx — 3 次修訂, 14天前
- office-xlsx — 3 次修訂, 14天前

**frontend/**
- ui-ux-pro-max — 3 次修訂, 14天前
- webapp-testing — 3 次修訂, 14天前

**git/**
- review-pr — 3 次修訂, 14天前

**meta/**
- dev-process-gate — 3 次修訂, 12天前
- plan-check-style — 3 次修訂, 12天前
- setup-permissions — 3 次修訂, 12天前

**quality/**
- code-reviewer — 3 次修訂, 14天前
- security-review — 3 次修訂, 14天前

**workflow/**
- customer-intel — 4 次修訂, 8天前
- dispatching-parallel-agents — 3 次修訂, 14天前
- executing-plans — 3 次修訂, 14天前
- headless-agent — 6 次修訂, 0天前
- investment-research — 3 次修訂, 9天前
- launchd-agent — 3 次修訂, 0天前
- planning-with-files — 4 次修訂, 10天前
- tender-scraper — 3 次修訂, 0天前
- writing-plans — 3 次修訂, 14天前

<details><summary>✅ 穩定 (39)</summary>

**backend/**
- db-migration — 1 次, 12天前
- firebase-backend — 1 次, 16天前
- imap-smtp-integration — 1 次, 0天前
- markdown-file-ssot — 1 次, 0天前
- oauth-token-vault — 1 次, 0天前
- sqlite-to-postgres — 1 次, 9天前
- tunnel-proxy-deploy — 1 次, 9天前

**docs/**
- telegram-bot — 1 次, 9天前

**frontend/**
- frontend-design — 2 次, 15天前
- ios-integration — 1 次, 16天前
- swiftui-patterns — 1 次, 16天前

**meta/**
- audit-fix — 1 次, 12天前
- ci-pipeline — 1 次, 12天前
- deploy — 1 次, 12天前
- init-project — 2 次, 15天前
- knowledge-graph — 1 次, 9天前
- self-improving-agent — 1 次, 9天前
- session-harvest — 1 次, 9天前
- skill-creator — 2 次, 15天前
- skill-scout — 1 次, 9天前

**quality/**
- de-slopify — 1 次, 9天前
- destructive-command-guard — 1 次, 9天前
- post-change-qa — 1 次, 12天前
- qa-auto — 1 次, 9天前
- qa-planner — 1 次, 9天前
- qa-testing — 1 次, 14天前
- systematic-debugging — 2 次, 15天前

**workflow/**
- autoresearch — 1 次, 0天前
- claude-to-telegram — 1 次, 9天前
- context-recovery — 1 次, 9天前
- crm-projection — 1 次, 8天前
- gdrive-to-skills — 2 次, 15天前
- keyword-discovery — 1 次, 0天前
- material-health — 1 次, 8天前
- mockup — 1 次, 16天前
- requirement — 1 次, 16天前
- sales-material — 1 次, 8天前
- subsidy-scraper — 1 次, 8天前
- user-flow — 1 次, 16天前
...
| | |
|---|---|
| **狀態** | 🔥 活躍 — 25 個 commit（本週）, 90 個（本月） |
| **技術棧** |  Docker Node.js Python |
| **分支** | `main` (2 total) |
| **Git** | 6 dirty, 17 unpushed |
| **CI/CD** | CI ❌ · 部署 ❌ · Hooks ✅ |
...
de090cb autoresearch(keyword-coverage): iter 7 — 107 → 111
323bf56 autoresearch(keyword-coverage): iter 6 — 102 → 107
```
</details>
...
xychart-beta
    ...
    y-axis "USD" 0 --> 450
    bar [321, 49, 0, 0, 0, 0, 394]
~~~

| 日期 | Sessions | API 呼叫 | Tokens | 預估花費 |
|------|----------|-----------|--------|-----------|
| 2026-03-18 (Wed) | 21 | 1,513 | 112.6M | $320.94 |
...
| 2026-03-24 (Tue) | 24 | 1,470 | 190.1M | $393.68 |
| **Total** | | | **319.7M** | **$764.10** |
...
|---------|-----------|--------|-----------|
| sales-assistant | 1,194 | 82.9M | $244.43 |
| rivendell | 746 | 120.6M | $220.09 |
| news-stock | 453 | 49.7M | $130.08 |
| -Users-manibari-Documents-Chimes-AI-josun | 264 | 23.9M | $58.87 |
| -Users-manibari-Documents-Projects | 313 | 24.4M | $57.04 |
| skills-test | 289 | 17.2M | $49.67 |
| news_stock | 13 | 313K | $21.10 |
...
*由以下工具產生 `./bin/sk audit` — 2026-03-24 — 63 skills, 15 issue(s)*
