...
**backend/**
- tw-company-lookup — 2 次修訂, 12天前
- web-scraper — 2 次修訂, 4天前

**workflow/**
- customer-intel — 4 次修訂, 12天前
- headless-agent — 6 次修訂, 4天前
- investment-research — 3 次修訂, 13天前
- launchd-agent — 3 次修訂, 4天前
- planning-with-files — 4 次修訂, 14天前
- tender-scraper — 3 次修訂, 4天前

<details><summary>✅ 穩定 (62)</summary>

**backend/**
- db-migration — 1 次, 16天前
- doc-to-structured-data — 1 次, 2天前
- firebase-backend — 1 次, 20天前
- imap-smtp-integration — 1 次, 4天前
- markdown-file-ssot — 1 次, 4天前
- oauth-token-vault — 1 次, 4天前
- sqlite-to-postgres — 1 次, 13天前
- tunnel-proxy-deploy — 1 次, 13天前

**docs/**
- mcp-builder — 3 次, 18天前
- office-docx — 3 次, 18天前
- office-pdf — 3 次, 18天前
- office-pptx — 3 次, 18天前
- office-xlsx — 3 次, 18天前
- telegram-bot — 1 次, 13天前

**frontend/**
- frontend-design — 2 次, 19天前
- ios-integration — 1 次, 20天前
- swiftui-patterns — 1 次, 20天前
- ui-ux-pro-max — 3 次, 18天前
- webapp-testing — 3 次, 18天前
...
**meta/**
- audit-fix — 1 次, 16天前
- ci-pipeline — 1 次, 16天前
- deploy — 1 次, 16天前
- dev-process-gate — 3 次, 16天前
- init-project — 2 次, 19天前
- knowledge-graph — 1 次, 13天前
- plan-check-style — 3 次, 16天前
- self-improving-agent — 1 次, 13天前
- session-harvest — 1 次, 13天前
- setup-permissions — 3 次, 16天前
- skill-creator — 2 次, 19天前
- skill-scout — 1 次, 13天前

**quality/**
- code-reviewer — 3 次, 18天前
- de-slopify — 1 次, 13天前
- destructive-command-guard — 1 次, 13天前
- post-change-qa — 1 次, 16天前
- protect-secrets — 1 次, 2天前
- qa-auto — 1 次, 13天前
- qa-planner — 1 次, 13天前
- qa-testing — 1 次, 18天前
- security-review — 3 次, 18天前
- systematic-debugging — 2 次, 19天前

**workflow/**
- agent-observability — 1 次, 3天前
- autoresearch — 1 次, 4天前
- candidate-analysis — 1 次, 2天前
- claude-to-telegram — 1 次, 13天前
- context-recovery — 1 次, 13天前
- crm-projection — 1 次, 12天前
- dispatching-parallel-agents — 3 次, 18天前
- executing-plans — 3 次, 18天前
- gdrive-to-skills — 2 次, 19天前
- keyword-discovery — 1 次, 4天前
- material-health — 1 次, 12天前
- mockup — 1 次, 20天前
- requirement — 1 次, 20天前
- sales-material — 1 次, 12天前
- settings-audit — 1 次, 3天前
- subsidy-scraper — 1 次, 12天前
- user-flow — 1 次, 20天前
- writing-plans — 3 次, 18天前
