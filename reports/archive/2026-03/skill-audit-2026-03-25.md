...
**backend/**
- tw-company-lookup — 2 次修訂, 9天前
- web-scraper — 2 次修訂, 1天前

**meta/**
- dev-process-gate — 3 次修訂, 13天前
- plan-check-style — 3 次修訂, 13天前
- setup-permissions — 3 次修訂, 13天前

**workflow/**
- customer-intel — 4 次修訂, 9天前
- headless-agent — 6 次修訂, 1天前
- investment-research — 3 次修訂, 10天前
- launchd-agent — 3 次修訂, 1天前
- planning-with-files — 4 次修訂, 11天前
- tender-scraper — 3 次修訂, 1天前

<details><summary>✅ 穩定 (54)</summary>

**backend/**
- db-migration — 1 次, 13天前
- firebase-backend — 1 次, 17天前
- imap-smtp-integration — 1 次, 1天前
- markdown-file-ssot — 1 次, 1天前
- oauth-token-vault — 1 次, 1天前
- sqlite-to-postgres — 1 次, 10天前
- tunnel-proxy-deploy — 1 次, 10天前

**docs/**
- mcp-builder — 3 次, 15天前
- office-docx — 3 次, 15天前
- office-pdf — 3 次, 15天前
- office-pptx — 3 次, 15天前
- office-xlsx — 3 次, 15天前
- telegram-bot — 1 次, 10天前

**frontend/**
- frontend-design — 2 次, 16天前
- ios-integration — 1 次, 17天前
- swiftui-patterns — 1 次, 17天前
- ui-ux-pro-max — 3 次, 15天前
- webapp-testing — 3 次, 15天前
...
**meta/**
- audit-fix — 1 次, 13天前
- ci-pipeline — 1 次, 13天前
- deploy — 1 次, 13天前
- init-project — 2 次, 16天前
- knowledge-graph — 1 次, 10天前
- self-improving-agent — 1 次, 10天前
- session-harvest — 1 次, 10天前
- skill-creator — 2 次, 16天前
- skill-scout — 1 次, 10天前

**quality/**
- code-reviewer — 3 次, 15天前
- de-slopify — 1 次, 10天前
- destructive-command-guard — 1 次, 10天前
- post-change-qa — 1 次, 13天前
- qa-auto — 1 次, 10天前
- qa-planner — 1 次, 10天前
- qa-testing — 1 次, 15天前
- security-review — 3 次, 15天前
- systematic-debugging — 2 次, 16天前

**workflow/**
- agent-observability — 1 次, 0天前
- autoresearch — 1 次, 1天前
- claude-to-telegram — 1 次, 10天前
- context-recovery — 1 次, 10天前
- crm-projection — 1 次, 9天前
- dispatching-parallel-agents — 3 次, 15天前
- executing-plans — 3 次, 15天前
- gdrive-to-skills — 2 次, 16天前
- keyword-discovery — 1 次, 1天前
- material-health — 1 次, 9天前
- mockup — 1 次, 17天前
- requirement — 1 次, 17天前
- sales-material — 1 次, 9天前
- settings-audit — 1 次, 0天前
- subsidy-scraper — 1 次, 9天前
- user-flow — 1 次, 17天前
- writing-plans — 3 次, 15天前
...
```
3489793 chore(agent): research-agent-daily run 2026-03-25
605d9e7 feat: redesign research page, fix pool/backtest/overview issues
ed5e13f chore(agent): research-agent-weekly run 2026-03-19
...
| | |
|---|---|
| **狀態** | 🔥 活躍 — 19 個 commit（本週）, 92 個（本月） |
| **技術棧** |  Docker Node.js Python |
| **分支** | `main` (2 total) |
| **Git** | 51 dirty, 1 unpushed |
| **CI/CD** | CI ❌ · 部署 ❌ · Hooks ✅ |
...
```
b9bf2ae fix: tender-scraper python→python3 + agent daily outputs
f855971 feat: add tender DB, AI response generation, and open-request template
666dd70 autoresearch(keyword-coverage): iter 10 — 120 → 124
6b2730f autoresearch(keyword-coverage): iter 9 — 116 → 120
ffc5745 autoresearch(keyword-coverage): iter 8 — 111 → 116
```
</details>
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["03-19", "03-20", "03-21", "03-22", "03-23", "03-24", "03-25"]
    y-axis "USD" 0 --> 550
    bar [49, 0, 0, 0, 0, 456, 259]
~~~

| 日期 | Sessions | API 呼叫 | Tokens | 預估花費 |
|------|----------|-----------|--------|-----------|
| 2026-03-19 (Thu) | 11 | 293 | 17.0M | $49.48 |
...
| 2026-03-25 (Wed) | 16 | 873 | 91.4M | $258.80 |
| **Total** | | | **319.7M** | **$763.98** |
...
|---------|-----------|--------|-----------|
| rivendell | 750 | 133.2M | $259.07 |
| sales-assistant | 1,055 | 74.4M | $206.09 |
| -Users-manibari-Documents-Projects | 517 | 53.3M | $138.91 |
| news-stock | 449 | 51.1M | $133.80 |
| news_stock | 14 | 336K | $22.68 |
| resume-pool | 94 | 5.7M | $17.48 |
| -Users-manibari-Documents-Chimes-AI-richwave | 28 | 920K | $3.92 |
| -Users-manibari-Documents-Chimes-AI-josun | 27 | 852K | $3.83 |
| curia | 7 | 118K | $0.88 |
...
*由以下工具產生 `./bin/sk audit` — 2026-03-25 — 65 skills, 15 issue(s)*
