...
**backend/**
- tw-company-lookup — 2 次修訂, 1天前

**docs/**
- mcp-builder — 3 次修訂, 7天前
- office-docx — 3 次修訂, 7天前
- office-pdf — 3 次修訂, 7天前
- office-pptx — 3 次修訂, 7天前
- office-xlsx — 3 次修訂, 7天前

**frontend/**
- frontend-design — 2 次修訂, 8天前
- ui-ux-pro-max — 3 次修訂, 7天前
- webapp-testing — 3 次修訂, 7天前

**git/**
- review-pr — 3 次修訂, 7天前

**meta/**
- dev-process-gate — 3 次修訂, 5天前
- init-project — 2 次修訂, 8天前
- plan-check-style — 3 次修訂, 5天前
- setup-permissions — 3 次修訂, 5天前
- skill-creator — 2 次修訂, 8天前

**quality/**
- code-reviewer — 3 次修訂, 7天前
- security-review — 3 次修訂, 7天前
- systematic-debugging — 2 次修訂, 8天前

**workflow/**
- customer-intel — 4 次修訂, 1天前
- dispatching-parallel-agents — 3 次修訂, 7天前
- executing-plans — 3 次修訂, 7天前
- gdrive-to-skills — 2 次修訂, 8天前
- headless-agent — 2 次修訂, 2天前
- investment-research — 3 次修訂, 2天前
- planning-with-files — 4 次修訂, 3天前
- writing-plans — 3 次修訂, 7天前

<details><summary>✅ 穩定 (32)</summary>

**backend/**
- db-migration — 1 次, 5天前
- firebase-backend — 1 次, 9天前
- sqlite-to-postgres — 1 次, 2天前
- tunnel-proxy-deploy — 1 次, 2天前
- web-scraper — 1 次, 1天前

**docs/**
- telegram-bot — 1 次, 2天前

**frontend/**
- ios-integration — 1 次, 9天前
- swiftui-patterns — 1 次, 9天前

**meta/**
- audit-fix — 1 次, 5天前
- ci-pipeline — 1 次, 5天前
- deploy — 1 次, 5天前
- knowledge-graph — 1 次, 2天前
- self-improving-agent — 1 次, 2天前
- session-harvest — 1 次, 2天前
- skill-scout — 1 次, 2天前

**quality/**
- de-slopify — 1 次, 2天前
- destructive-command-guard — 1 次, 2天前
- post-change-qa — 1 次, 5天前
- qa-auto — 1 次, 2天前
- qa-planner — 1 次, 2天前
- qa-testing — 1 次, 7天前

**workflow/**
- claude-to-telegram — 1 次, 2天前
- context-recovery — 1 次, 2天前
- crm-projection — 1 次, 1天前
- launchd-agent — 1 次, 2天前
- material-health — 1 次, 1天前
- mockup — 1 次, 9天前
- requirement — 1 次, 9天前
- sales-material — 1 次, 1天前
- subsidy-scraper — 1 次, 1天前
- tender-scraper — 1 次, 0天前
- user-flow — 1 次, 9天前
...
| | |
|---|---|
| **狀態** | 🔥 活躍 — 22 個 commit（本週）, 77 個（本月） |
| **技術棧** |  Docker Node.js Python |
| **分支** | `main` (1 total) |
| **Git** | 4 dirty, 1 unpushed |
| **CI/CD** | CI ❌ · 部署 ❌ · Hooks ❌ |
...
3566045 chore(agent): research-agent-weekly run 2026-03-17
acd01f4 chore(agent): research-agent-daily run 2026-03-17
...
```
50e9756 feat(subsidies): auto-close expired subsidies on backend startup
295a0d6 feat(outreach): add cold outreach workbench with AI pitch generation
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["03-11", "03-12", "03-13", "03-14", "03-15", "03-16", "03-17"]
    y-axis "USD" 0 --> 800
    bar [707, 125, 92, 471, 688, 5, 195]
~~~
...
| 2026-03-17 (Tue) | 15 | 849 | 57.7M | $195.36 |
| **Total** | | | **951.2M** | **$2282.00** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| sales-assistant | 3,993 | 382.0M | $787.68 |
| -Users-manibari-Documents-Projects | 1,898 | 194.7M | $476.23 |
| skills-test | 2,448 | 175.2M | $419.17 |
| news-stock | 960 | 54.4M | $194.70 |
| TailTrack | 678 | 67.2M | $174.17 |
| -Users-manibari-Documents-Chimes-AI-richwave | 552 | 45.9M | $148.75 |
| scraper | 386 | 31.5M | $79.50 |
| news_stock | 10 | 246K | $16.83 |
...
*由以下工具產生 `./bin/sk audit` — 2026-03-17 — 58 skills, 11 issue(s)*
