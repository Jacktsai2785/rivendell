...
**backend/**
- tw-company-lookup — 2 次修訂, 3天前

**docs/**
- mcp-builder — 3 次修訂, 9天前
- office-docx — 3 次修訂, 9天前
- office-pdf — 3 次修訂, 9天前
- office-pptx — 3 次修訂, 9天前
- office-xlsx — 3 次修訂, 9天前

**frontend/**
- frontend-design — 2 次修訂, 10天前
- ui-ux-pro-max — 3 次修訂, 9天前
- webapp-testing — 3 次修訂, 9天前

**git/**
- review-pr — 3 次修訂, 9天前

**meta/**
- dev-process-gate — 3 次修訂, 7天前
- init-project — 2 次修訂, 10天前
- plan-check-style — 3 次修訂, 7天前
- setup-permissions — 3 次修訂, 7天前
- skill-creator — 2 次修訂, 10天前

**quality/**
- code-reviewer — 3 次修訂, 9天前
- security-review — 3 次修訂, 9天前
- systematic-debugging — 2 次修訂, 10天前

**workflow/**
- customer-intel — 4 次修訂, 3天前
- dispatching-parallel-agents — 3 次修訂, 9天前
- executing-plans — 3 次修訂, 9天前
- gdrive-to-skills — 2 次修訂, 10天前
- headless-agent — 3 次修訂, 1天前
- investment-research — 3 次修訂, 4天前
- planning-with-files — 4 次修訂, 5天前
- tender-scraper — 2 次修訂, 1天前
- writing-plans — 3 次修訂, 9天前

<details><summary>✅ 穩定 (31)</summary>

**backend/**
- db-migration — 1 次, 7天前
- firebase-backend — 1 次, 11天前
- sqlite-to-postgres — 1 次, 4天前
- tunnel-proxy-deploy — 1 次, 4天前
- web-scraper — 1 次, 3天前

**docs/**
- telegram-bot — 1 次, 4天前

**frontend/**
- ios-integration — 1 次, 11天前
- swiftui-patterns — 1 次, 11天前

**meta/**
- audit-fix — 1 次, 7天前
- ci-pipeline — 1 次, 7天前
- deploy — 1 次, 7天前
- knowledge-graph — 1 次, 4天前
- self-improving-agent — 1 次, 4天前
- session-harvest — 1 次, 4天前
- skill-scout — 1 次, 4天前

**quality/**
- de-slopify — 1 次, 4天前
- destructive-command-guard — 1 次, 4天前
- post-change-qa — 1 次, 7天前
- qa-auto — 1 次, 4天前
- qa-planner — 1 次, 4天前
- qa-testing — 1 次, 9天前

**workflow/**
- claude-to-telegram — 1 次, 4天前
- context-recovery — 1 次, 4天前
- crm-projection — 1 次, 3天前
- launchd-agent — 1 次, 4天前
- material-health — 1 次, 3天前
- mockup — 1 次, 11天前
- requirement — 1 次, 11天前
- sales-material — 1 次, 3天前
- subsidy-scraper — 1 次, 3天前
- user-flow — 1 次, 11天前
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["03-13", "03-14", "03-15", "03-16", "03-17", "03-18", "03-19"]
    y-axis "USD" 0 --> 750
    bar [92, 471, 688, 5, 554, 321, 49]
~~~
...
| 2026-03-19 (Thu) | 9 | 293 | 17.0M | $49.48 |
| **Total** | | | **887.9M** | **$2179.71** |

### 各專案花費（7 日）

| 專案 | API 呼叫 | Tokens | 預估花費 |
|---------|-----------|--------|-----------|
| sales-assistant | 3,171 | 313.3M | $696.93 |
| -Users-manibari-Documents-Projects | 1,856 | 235.2M | $549.58 |
| skills-test | 2,768 | 191.0M | $479.94 |
| news-stock | 1,153 | 73.6M | $248.90 |
...
*由以下工具產生 `./bin/sk audit` — 2026-03-19 — 61 skills, 15 issue(s)*
