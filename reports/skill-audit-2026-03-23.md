...
**backend/**
- tw-company-lookup — 2 次修訂, 7天前

**docs/**
- mcp-builder — 3 次修訂, 13天前
- office-docx — 3 次修訂, 13天前
- office-pdf — 3 次修訂, 13天前
- office-pptx — 3 次修訂, 13天前
- office-xlsx — 3 次修訂, 13天前

**frontend/**
- frontend-design — 2 次修訂, 14天前
- ui-ux-pro-max — 3 次修訂, 13天前
- webapp-testing — 3 次修訂, 13天前

**git/**
- review-pr — 3 次修訂, 13天前

**meta/**
- dev-process-gate — 3 次修訂, 11天前
- init-project — 2 次修訂, 14天前
- plan-check-style — 3 次修訂, 11天前
- setup-permissions — 3 次修訂, 11天前
- skill-creator — 2 次修訂, 14天前

**quality/**
- code-reviewer — 3 次修訂, 13天前
- security-review — 3 次修訂, 13天前
- systematic-debugging — 2 次修訂, 14天前

**workflow/**
- customer-intel — 4 次修訂, 7天前
- dispatching-parallel-agents — 3 次修訂, 13天前
- executing-plans — 3 次修訂, 13天前
- gdrive-to-skills — 2 次修訂, 14天前
- headless-agent — 3 次修訂, 5天前
- investment-research — 3 次修訂, 8天前
- planning-with-files — 4 次修訂, 9天前
- tender-scraper — 2 次修訂, 5天前
- writing-plans — 3 次修訂, 13天前

<details><summary>✅ 穩定 (31)</summary>

**backend/**
- db-migration — 1 次, 11天前
- firebase-backend — 1 次, 15天前
- sqlite-to-postgres — 1 次, 8天前
- tunnel-proxy-deploy — 1 次, 8天前
- web-scraper — 1 次, 7天前

**docs/**
- telegram-bot — 1 次, 8天前

**frontend/**
- ios-integration — 1 次, 15天前
- swiftui-patterns — 1 次, 15天前

**meta/**
- audit-fix — 1 次, 11天前
- ci-pipeline — 1 次, 11天前
- deploy — 1 次, 11天前
- knowledge-graph — 1 次, 8天前
- self-improving-agent — 1 次, 8天前
- session-harvest — 1 次, 8天前
- skill-scout — 1 次, 8天前

**quality/**
- de-slopify — 1 次, 8天前
- destructive-command-guard — 1 次, 8天前
- post-change-qa — 1 次, 11天前
- qa-auto — 1 次, 8天前
- qa-planner — 1 次, 8天前
- qa-testing — 1 次, 13天前

**workflow/**
- claude-to-telegram — 1 次, 8天前
- context-recovery — 1 次, 8天前
- crm-projection — 1 次, 7天前
- launchd-agent — 1 次, 8天前
- material-health — 1 次, 7天前
- mockup — 1 次, 15天前
- requirement — 1 次, 15天前
- sales-material — 1 次, 7天前
- subsidy-scraper — 1 次, 7天前
- user-flow — 1 次, 15天前
...
xychart-beta
    title "每日花費（USD）"
    x-axis ["03-17", "03-18", "03-19", "03-20", "03-21", "03-22", "03-23"]
    y-axis "USD" 0 --> 650
    bar [554, 321, 49, 0, 0, 0, 0]
~~~
...
|---------|-----------|--------|-----------|
| sales-assistant | 1,406 | 129.1M | $346.86 |
| -Users-manibari-Documents-Projects | 311 | 70.7M | $179.65 |
| news-stock | 695 | 48.6M | $155.28 |
| skills-test | 704 | 50.7M | $148.27 |
...
*由以下工具產生 `./bin/sk audit` — 2026-03-23 — 61 skills, 18 issue(s)*
